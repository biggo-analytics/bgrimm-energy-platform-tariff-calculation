/**
 * PEA_3.2.1_medium_TOU Strategy
 * PEA 3.2.1 medium TOU (>=69kV)
 */
...
class PEA_3_2_1_medium_TOU extends ICalculationStrategy {
  constructor() {
    const rates = {
    "demand_on": 74.14,
    "energy_on": 4.1025,
  ...
  getCalculationType() { return '3.2.1'; }
...
module.exports = PEA_3_2_1_medium_TOU;