/**
 * PEA_4.2.1_large_TOU Strategy
 * PEA 4.2.1 large TOU (>=69kV)
 */
...
class PEA_4_2_1_large_TOU extends ICalculationStrategy {
  constructor() {
    const rates = {
    "demand_on": 74.14,
    "energy_on": 4.1025,
  ...
  getCalculationType() { return '4.2.1'; }
...
module.exports = PEA_4_2_1_large_TOU;