/**
 * PEA_4.2.3_large_TOU Strategy
 * PEA 4.2.3 large TOU (<22kV)
 */
...
class PEA_4_2_3_large_TOU extends ICalculationStrategy {
  constructor() {
    const rates = {
    "demand_on": 210,
    "energy_on": 4.3297,
  ...
  getCalculationType() { return '4.2.3'; }
...
module.exports = PEA_4_2_3_large_TOU;