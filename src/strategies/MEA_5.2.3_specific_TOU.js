/**
 * MEA_5.2.3_specific_TOU Strategy
 * MEA 5.2.3 specific TOU (<12kV)
 */
...
class MEA_5_2_3_specific_TOU extends ICalculationStrategy {
  constructor() {
    const rates = {
    "demand_on": 210.8,
    "energy_on": 4.5297,
...
module.exports = MEA_5_2_3_specific_TOU;