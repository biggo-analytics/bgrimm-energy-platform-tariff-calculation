/**
 * PEA_5.1.3_specific_TOU Strategy
 * PEA 5.1.3 specific TOU (<22kV)
 */
...
class PEA_5_1_3_specific_TOU extends ICalculationStrategy {
  constructor() {
    const rates = {
    "demand_on": 210,
    "energy_on": 4.3297,
...
module.exports = PEA_5_1_3_specific_TOU;