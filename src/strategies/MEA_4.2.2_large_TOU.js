/**
 * MEA_4.2.2_large_TOU Strategy
 * MEA 4.2.2 large TOU (12-24kV)
 */
...
class MEA_4_2_2_large_TOU extends ICalculationStrategy {
  constructor() {
    const rates = {
    "demand_on": 132.93,
    "energy_on": 4.1839,
  ...
  getCalculationType() { return '4.2.2'; }
...
module.exports = MEA_4_2_2_large_TOU;