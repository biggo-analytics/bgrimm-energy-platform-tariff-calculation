/**
 * PEA_5.1.1_specific_TOU Strategy
 * PEA 5.1.1 specific TOU (>=69kV)
 */
...
class PEA_5_1_1_specific_TOU extends ICalculationStrategy {
  constructor() {
    const rates = {
    "demand_on": 74.14,
    "energy_on": 4.1025,
...
module.exports = PEA_5_1_1_specific_TOU;