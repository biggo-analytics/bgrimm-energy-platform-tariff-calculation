/**
 * MEA Electricity Controller (Strategy Pattern)
...
const meaElectricityStrategyService = require('../services/mea-electricity-strategy.service');

class MEAElectricityStrategyController extends BaseElectricityController {
  constructor() {
    super(meaElectricityStrategyService, 'mea');
  }
...
const meaElectricityStrategyController = new MEAElectricityStrategyController();

module.exports = {
  calculateType2: (ctx) => meaElectricityStrategyController.calculateType2(ctx),
  calculateType3: (ctx) => meaElectricityStrategyController.calculateType3(ctx),
  calculateType4: (ctx) => meaElectricityStrategyController.calculateType4(ctx),
  calculateType5: (ctx) => meaElectricityStrategyController.calculateType5(ctx),
  getServiceInfo: (ctx) => meaElectricityStrategyController.getServiceInfo(ctx),
  getRateInfo: (ctx) => meaElectricityStrategyController.getRateInfo(ctx),
  getAvailableTariffTypes: (ctx) => meaElectricityStrategyController.getAvailableTariffTypes(ctx)
};
